...
kable(terrorists_attack[1:10, c("provstate", "city", "targtype1_txt", "target1", "nkill", "nwound")], col.names = c("Governate", "City","Target type","Target","Killed","Wounded"), "html") %>% 
...
leaflet(attacks_locations) %>% 
  addTiles() %>% 
  addCircleMarkers(lat = attacks_locations$latitude, 
